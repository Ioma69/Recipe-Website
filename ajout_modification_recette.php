   ...
   if (isset($_POST['saveRecipe'])) {
        $fileName = null;
      // si un ficher a ete envoyé   
      if(isset($_FILES['file']['tmp_name']) && $_FILES['file']['tmp_name'] != '') {   // tmp_name fichier copié dans un dossier temporaire et apres il faut le deplacer dans le bon dossier
    ...
    if ($res) {
        $messages[] = ' la recette a bien été sauveegardée';
    } else {
        $errors[] = 'la recette n\'a pas été sauveegardée';
    }
}
